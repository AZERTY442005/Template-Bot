...
module.exports = {
    ...
    execute(message, args) {
        ...
        try {
            if(!message.member.hasPermission("MANAGE_CHANNELS") && message.author.id != config["CreatorID"] && fs.readFileSync("./DataBase/admin", "utf8")=="off") return message.lineReply("Erreur: Vous n'avez pas la permission de faire ceci! (Gérer les Salons")
